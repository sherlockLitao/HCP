...
from ae.trainer_swae import SWAEBatchTrainer
...
def main():
    ...
    parser.add_argument('--outdir', default='./output/swae/', help='directory to output images and model checkpoints')
    ...
    np.save('sw_loss.npy', sw_loss)
    np.save('sw_lossv.npy', sw_lossv)
