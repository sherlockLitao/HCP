# python test_swae.py --source-data MNIST
# python test_swae.py --source-data CelebA --landmark-interval 1
import argparse
import pickle
...
if __name__ == '__main__':
    ...
    torch.save(model.state_dict(),
               '{}/swae_model_{}.pt'.format(args.resultpath, args.source_data))
    with open('{}/swae_loss_{}.pkl'.format(args.resultpath, args.source_data), 'wb') as f:
        pickle.dump(loss, f)
    print('\n')
